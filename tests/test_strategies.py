...
class TestReversalBundle:
    ...
    def test_signal_on_reversal_setup(self, sample_ohlcv_reversal):
        ...
        assert len(strat.trade_log) >= 0  # May or may not trigger depending on exact conditions
...
class TestCompositeBundle:
    ...
    @pytest.mark.skip(reason="Composite bundle peer spawning has issues with backtrader")
