    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            if len(check_buttons) > 0:
                ...
                page.screenshot(
                    path=f"{SCREENSHOT_DIR}/portfolio_before_check.png", full_page=True
                )
                ...
                page.screenshot(
                    path=f"{SCREENSHOT_DIR}/portfolio_after_check.png", full_page=True
                )
                print("   ✓ 'Check' button clicked")
                print(
                    "   📸 Screenshots: portfolio_before_check.png, portfolio_after_check.png"
                )
                print(
                    "   📝 PURPOSE: Pre-trade risk check - validates if you have enough cash/positions"
                )
        ...
        try:
            ...
            if len(text_inputs) > 0:
                ...
                page.screenshot(
                    path=f"{SCREENSHOT_DIR}/signals_before_analyze.png", full_page=True
                )
                ...
                if len(analyze_buttons) > 0:
                    ...
                    print(
                        "   📝 PURPOSE: Run full 5-agent analysis pipeline on the symbol"
                    )
                ...
                page.screenshot(
                    path=f"{SCREENSHOT_DIR}/signals_ready_to_analyze.png",
                    full_page=True,
                )
        ...
        try:
            ...
            if len(add_buttons) > 0:
                ...
                page.screenshot(
                    path=f"{SCREENSHOT_DIR}/watchlist_add_button.png", full_page=True
                )
        ...
        try:
            ...
            page.screenshot(
                path=f"{SCREENSHOT_DIR}/news_feed_buttons.png", full_page=True
            )
