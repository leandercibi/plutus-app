    ...
    with sync_playwright() as p:
        ...
        for i, tab_name in enumerate(tabs, start=2):
            ...
            try:
                ...
                page.screenshot(path=f"{SCREENSHOT_DIR}/{screenshot_name}", full_page=True)
                print(f"   ✓ Tab loaded")
        ...
        try:
            ...
            page.screenshot(path=f"{SCREENSHOT_DIR}/10_signals_interactions.png", full_page=True)
        ...
        try:
            ...
            page.screenshot(path=f"{SCREENSHOT_DIR}/11_portfolio_interactions.png", full_page=True)
        ...
        try:
            ...
            page.screenshot(path=f"{SCREENSHOT_DIR}/12_watchlist_interactions.png", full_page=True)
        ...
        try:
            ...
            page.screenshot(path=f"{SCREENSHOT_DIR}/13_settings_config.png", full_page=True)
        ...
        try:
            page.screenshot(path=f"{SCREENSHOT_DIR}/15_strategy_lab.png", full_page=True)
