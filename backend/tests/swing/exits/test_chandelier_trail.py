...
def test_trail_uses_highest_high_minus_n_atr() -> None:
    ...
    stop = trail.trail_stop(candles, entry_idx=0, current_idx=4, n_atr=3.0, atr_period=3)
...
def test_trail_tightens_as_new_highs_print() -> None:
    ...
    candles = _candles(highs, lows, closes)
    trail = ChandelierTrail()
    earlier = trail.trail_stop(candles, entry_idx=0, current_idx=3, n_atr=3.0, atr_period=3)
    later = trail.trail_stop(candles, entry_idx=0, current_idx=5, n_atr=3.0, atr_period=3)
