...
class TestConfigDefaults:
    ...
    def test_database_defaults(self, mock_env_vars, monkeypatch, tmp_path):
        ...
        assert (
            ...
            == "postgresql://plutus:plutus@localhost:5432/plutus_db"
        )
...
class TestConfigCaching:
    ...
    def test_settings_singleton_behavior(self, mock_env_vars):
        ...
        assert (
            imported_settings.OPENROUTER_API_KEY == cached_settings.OPENROUTER_API_KEY
        )
        assert (
            imported_settings.TELEGRAM_BOT_TOKEN == cached_settings.TELEGRAM_BOT_TOKEN
        )
